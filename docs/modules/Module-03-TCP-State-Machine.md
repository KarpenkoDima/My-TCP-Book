...
[...без изменений — существующий текст с диаграммой snd_una/snd_nxt и
struct tcp_sock...]

### 3.4.2 Window Scaling (send-side)

[...без изменений — существующий текст про RFC 7323...]

### 3.4.3 Delayed ACK (receive-side)

[...без изменений, кроме исправленной ссылки: "Решение: TCP_NODELAY
(подробнее — Модуль 6, 6.4)" вместо битой ссылки на Модуль 5...]
...
[...текст как в предыдущем патче, без изменений, только перенумерован
с 3.4.4 на 3.4.5...]

### 3.4.6 RCV.NXT — что уже точно доставлено приложению

[...текст как в предыдущем патче, перенумерован с 3.4.5 на 3.4.6...]

### 3.4.7 Out-of-Order Queue

[...текст как в предыдущем патче, перенумерован с 3.4.6 на 3.4.7...]

### 3.4.8 Overlapping и Duplicate сегменты

[...текст как в предыдущем патче, перенумерован с 3.4.7 на 3.4.8...]

### 3.4.9 Memory Management

[...текст как в предыдущем патче, перенумерован с 3.4.8 на 3.4.9...]

---

### 3.4.10 Практический проект: TcpOutOfOrderReassembler

[...весь текст практического проекта из предыдущего патча (структура
проекта, "Ключевые инженерные решения", "Тесты", "Как проверить себя") —
без изменений, только перенумерован с 3.4.9 на 3.4.10...]
